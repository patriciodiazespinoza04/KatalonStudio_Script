...
//WebUI.click(findTestObject('Object Repository/Page_BNamericas - Set De Datos/p'))

//WebUI.setText(findTestObject('Object Repository/Page_BNamericas - Sets de datos - Editar Set de datos/div_Redo_fr-element fr-view'),'Descripcion QA')

//WebUI.setText(findTestObject('Object Repository/Page_BNamericas - Sets de datos - Editar Set de datos/div_Descripcion QA'),'Descripcion QA')

//WebUI.setText(findTestObject('Object Repository/Page_BNamericas - Set De Datos/div_Descripcion insights'), 'Descripcion insights')
//WebUI.click(findTestObject('Object Repository/Page_BNamericas - Set De Datos/p'))
//WebUI.setText(findTestObject('Object Repository/Page_BNamericas/div_Detalle del Rol QA'), 'Descripcion QA')
//WebUI.click(findTestObject('Object Repository/Page_BNamericas - Set De Datos/div_Descripcion QA'))
//WebUI.setText(findTestObject('Object Repository/Page_BNamericas - Set De Datos/div_Descripcion QA'), 'Descripcion QA')
WebUI.delay(1)
