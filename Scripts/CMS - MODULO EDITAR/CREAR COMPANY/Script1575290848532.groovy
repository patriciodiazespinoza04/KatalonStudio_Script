...
WebUI.setText(findTestObject('Object Repository/Page_BNamericas - Compaas - Editar Compaa/div_Ingreso de Detalle del Rol en Spanish'), 
    'Ingreso de Detalle del Rol en Spanish')
