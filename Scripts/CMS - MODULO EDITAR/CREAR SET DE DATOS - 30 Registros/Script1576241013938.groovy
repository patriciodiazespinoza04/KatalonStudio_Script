...
for (i = 1; i <= 30; i++) {
    ...
    WebUI.setText(findTestObject('Object Repository/Page_BNamericas - Noticias - Editar Noticia/input_Relacionar noticias'), 
        findTestData('ARTICLE_TRANSLATION').getValue(1, 1))
...
for (i = 1; i <= 30; i++) {
	...
	WebUI.setText(findTestObject('Object Repository/Page_BNamericas - Noticias - Editar Noticia/input_Relacionar proyectos_form-control border-right-0 ng-pristine ng-untouched ng-valid ng-empty'), findTestData('PROJECT_TRANSLATION').getValue(1, 1))
...
for (i = 1; i <= 29; i++) {
	...
	WebUI.setText(findTestObject('Object Repository/Page_BNamericas - Noticias - Nuevo artculo/Buscar_Company'), findTestData('COMPANY_TRANSLATION').getValue(1, 1))
	//WebUI.setText(findTestObject('Object Repository/Page_BNamericas - Noticias - Nuevo artculo/Buscar_Company'), COMPANY)
	//WebUI.setText(findTestObject('Object Repository/Page_BNamericas - Noticias - Nuevo artculo/Buscar_Company'), 'Citibank N.A., Sucursal Ecuador')
...
for (i = 1; i <= 30; i++) {
	...
	WebUI.setText(findTestObject('Object Repository/Page_BNamericas - Noticias - Editar Noticia/input_Relacionar personas_form-control border-right-0 ng-pristine ng-untouched ng-valid ng-empty'), findTestData('PERSON_TRANSLATION').getValue(1, 1))
...
for (i = 1; i <= 30; i++) {
	...
	WebUI.setText(findTestObject('Object Repository/Page_BNamericas - Noticias - Editar Noticia/input_Relacionar reportes_form'), findTestData('REPORT_TRANSLATION').getValue(1, 1))
...
for (i = 1; i <= 30; i++) {
	...
	WebUI.setText(findTestObject('Object Repository/Page_BNamericas - Noticias - Editar Noticia/input_Relacionar set de datos_form-control border-right-0 ng-pristine ng-untouched ng-valid ng-empty'), findTestData('DATASET_TRANSLATION').getValue(1, 1))
